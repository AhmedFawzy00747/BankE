...
import '../../bloc/otp/otp_event.dart' as otp;
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => LoginOtpScreen(
                          destination: _identifierController.text.trim(),
                          isPhone: _isPhone,
                        )
                      )
                    );
                  ...
                  return SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: state is AuthLoading ? null : () {
                        ...
                        if (_isPhone && identity.length < 10) {
                          ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        context.read<OtpBloc>().add(otp.SendOtpEvent(identity));
                      },
