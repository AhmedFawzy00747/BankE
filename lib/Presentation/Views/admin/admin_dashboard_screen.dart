              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (amount != 0) {
                    context
                        .read<AdminBloc>()
                        .add(AdjustBalanceEvent(user.id, amount));
                  }
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                              child: _buildStatCard('Total Users',
                                  state.users.length.toString(), Icons.people)),
                          const SizedBox(width: 16),
                          Expanded(
                              child: _buildStatCard(
                                  'Liquidity',
                                  formatter.format(state.totalLiquidity),
                      ...
                      const SizedBox(height: 32),
                      const Text('Global Transaction History',
                          style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: Colors.white)),
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: () => context
                          .read<AdminBloc>()
                          .add(UpdateLoanStatusEvent(loan.id, false)),
                    ...
                    ElevatedButton(
                      onPressed: () => context
                          .read<AdminBloc>()
                          .add(UpdateLoanStatusEvent(loan.id, true)),
                      style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.tealAccent,
                          foregroundColor: Colors.black),
